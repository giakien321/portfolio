...
import { usePathname } from "next/navigation"; // ⬅️ thêm dòng này để lấy pathname
...
export default function WorkPreview() {
  ...
  const pathname = usePathname(); // ⬅️ sử dụng pathname làm key cho section
  ...
  return (
    <motion.section
      key={pathname} // ⬅️ reset animation khi pathname thay đổi
