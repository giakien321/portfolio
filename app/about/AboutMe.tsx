        ...
        <>
                ...
                <div className="max-w-6xl mx-auto space-y-16">
                    <div className="grid grid-cols-1 md:grid-cols-[auto_122px_1fr] items-center">
                        ...
                        >
                            ...
                            />
                            <span className="w-[190px] h-[52px] absolute top-[-20px] left-[-24px] 
              bg-[#DE7D08] text-white rounded-full text-base font-bevietnam font-bold shadow-md
              flex items-center justify-center text-center">
                                11th August 2004
                            </span>
                            <span className="w-[190px] h-[52px] absolute bottom-[-20px] right-[-24px] 
              bg-[#DE7D08] text-white rounded-full text-base font-bevietnam font-bold shadow-md
              flex items-center justify-center text-center">
                                Vietnamese
                            </span>
                    ...
                    <div className="flex flex-col gap-14 pl-10">
                        ...
                        {[
                            ...
                            >
                                {edu.height > 0 && (
                                    <div
                                        className={`absolute left-[-30px] top-1.5 w-[2px] h-[${edu.height}px] bg-black`}
                                    />
                                )}
            ...
            >
                ...
                <SkillCard
                    ...
                    items={[
                        'Leading', 'Teamwork', 'Creativity', 'Communication',
                        'Time management', 'Layout', 'Copywriting', 'Adaptive'
                    ]}
                />
            </motion.div>
            ...
            >
                <ul className="space-y-6">
                    {[
                        { year: '2020 – 2021 / Video Editor', desc: 'Description...' },
                        { year: '2022 – 2023 / Freelance Website Builder', desc: 'Description...' },
                    ].map((exp, i) => (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {tags.map((tag) => (
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <span className="inline-block px-6 py-2 border-[1.5px] border-black rounded-full 
                        font-alt font-semibold text-[20px] leading-[30px]">
                        {tag.label}
                    </span>
            ...
            {items && (
                ...
                >
                    {items.map((item, i) => (
                        <li
                            key={i}
                            className={item === item.toUpperCase() ? 'font-bold' : ''}
                        >
                            {item}
                        </li>
                    ))}
